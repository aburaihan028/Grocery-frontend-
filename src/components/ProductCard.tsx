...
const ProductCart = ({ product }: Props) => {
  ...
  return (
    <div
      className="bg-white rounded-2xl overflow-hidden shadow hover:shadow-md transition-all duration-300 animate-fade-in group cursor-pointer"
      ...
      <div className="p-3.5 text-zinc-700">
        ...
        {product?.rating > 0 && (
          <div className="flex items-center gap-1 mb-2">
            <StarIcon className="lucide lucide-star size-3 text-app-warning fill-app-warning" />
