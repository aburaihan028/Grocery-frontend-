...
const Navbar = () => {
  ...
  // handle search function emplement
        ...
        <div className="w-full flex items-center justify-end gap-4 lg:gap-10">
          ...
          >
            <div className="relative w-full">
              <SearchIcon className="lucide lucide-search absolute left-2.5 top-1/2 -translate-y-1/2 size-4 text-zinc-500" />
              <input
                type="text"
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              {user ? (
                ...
                >
                  <div className="size-7 rounded-full bg-gray-900 text-white flex-center">
