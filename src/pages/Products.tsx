...
const Products = () => {
  ...
  const [mobileFiletersOpen, setMobileFiletersOpen] = useState(false);
  ...
  useEffect(() => {
    fetchProducts();
  }, [category, organic, sort, page, maxPrice, maxPrice]);
  ...
  return (
    <div className="min-h-screen bg-app-cream">
          ...
          <main className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex flex-col lg:items-center gap-3">
                ...
                <button
                  onClick={() => setMobileFiletersOpen(true)}
            ...
            {loading ? (
              ...
              // product list
              <ProductList products={products} grid4={true} />
            )}
            {/* Pagination */}
            {totalPages > 1 && (
              <div className="flex-center gap-2 mt16">
      ...
      {/* Mobitle Filters Modal */}
      {mobileFiletersOpen && (
        <>
          {/* Overly */}
          <div
            className="fixed inset-0 bg-black/40 z-50"
            onClick={() => setMobileFiletersOpen(false)}
          />
          {/* header  */}
